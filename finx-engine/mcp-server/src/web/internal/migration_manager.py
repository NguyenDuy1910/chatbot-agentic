...
from src.web.constants.config import SRC_LOG_LEVELS, get_database_url
from src.web.internal.db import Base, init_database
...
class MigrationManager:
    ...
    def create_tables_if_not_exist(self):
        ...
        try:
            ...
            # Create all tables
            from src.web.internal.db import engine
            if engine:
