"""
Question Recommendation Node.

This node generates recommended questions based on database schema and optional user context.
Adapted from src/generation/question_recommendation.py
"""
...
from src.graphs.common import clean_up_new_lines
...
async def question_recommendation_node(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        prompt_text = prompt_template.format(
            ...
            previous_questions=query if query else None,
        ...
        recommendation_result = await generator(prompt=prompt_text)
